export default function Checkbox({ habit, checked, onComplete, onIncomplete, onToggle }) {
  function handleClick() {

    if (checked) {
      if (habit.streak !== undefined && habit.streak > 0) {
        onIncomplete();
        checked = habit.habitDone;
      }
    } else {
    ...
    return (
      <button className="checkbox" onClick={onToggle}>
        {!checked && (
          ...
          <svg className="checkbox" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
